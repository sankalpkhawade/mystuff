package com.cognizant.Vehicle_RS.security;
...
import com.cognizant.Vehicle_RS.VehicleRsApplication;
...
public class JwtAuthorizationFilter<Claims> extends BasicAuthenticationFilter {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(VehicleRsApplication.class);
